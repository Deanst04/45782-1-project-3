...
router.post('/', 
    enforceAdmin, 
    validation(createVacationValidator, "body"), 
    validation(newVacationImageValidation, 'files'), 
    fileUploader, 
    createVacation
)
router.patch('/:vacationId', 
    enforceAdmin, 
    validation(idByParamsValidator("vacationId"), "params"), 
    validation(editVacationValidator, "body"),
    validation(editVacationImageValidation, 'files'), 
    fileUploader, 
    editVacation
)
router.delete('/:vacationId', 
    enforceAdmin, 
    validation(idByParamsValidator("vacationId"), "params"), 
    deleteVacation
)
